...
def C_R_1(phi):
    ...
    CR = np.kron(np.kron(np.kron(zero_state, zero_state), zero_state), R1) + \
         np.kron(np.kron(np.kron(zero_state, zero_state), one_state),
                 Identity) + \
         np.kron(np.kron(np.kron(zero_state, one_state), zero_state),
                 Identity) + \
         np.kron(np.kron(np.kron(zero_state, one_state), one_state), Identity) + \
         np.kron(np.kron(np.kron(one_state, zero_state), zero_state),
                 Identity) + \
...
def C_R_2(phi):
    ...
    CR = np.kron(np.kron(np.kron(zero_state, zero_state), zero_state),
                 Identity) + \
...
def C_NOT_001():
    ...
    NOT = np.kron(np.kron(Identity, Identity),
                  np.kron(zero_state, sigma_x) + np.kron(one_state, Identity))
    # I@I@(1X + 0I)
    return Operator(NOT)
...
def C_NOT_010():
    ...
    """
    NOT = np.kron(Identity,
                  np.kron(zero_state, np.kron(Identity, Identity)) + np.kron(
                      one_state, np.kron(Identity, sigma_x)))
    # I@(0@I@I + 1@I@X)
    return Operator(NOT)
...
def C_NOT_100():
    ...
    """
    NOT = np.kron(zero_state,
                  np.kron(Identity, np.kron(Identity, Identity))) + np.kron(
        one_state, np.kron(Identity, np.kron(Identity, sigma_x)))
    # (0@I@I@I + 1@I@I@X)
    return Operator(NOT)
...
def get_R(PHI):
    ...
    R1 = Operator(np.kron(np.kron(np.kron(Identity, Identity), Identity),
                          rotation_matrix(THETA[0])))
    R2 = Operator(np.kron(np.kron(np.kron(Identity, Identity), Identity),
                          rotation_matrix(THETA[1])))
    R3 = Operator(np.kron(np.kron(np.kron(Identity, Identity), Identity),
                          rotation_matrix(THETA[2])))
    R4 = Operator(np.kron(np.kron(np.kron(Identity, Identity), Identity),
                          rotation_matrix(THETA[3])))
    R5 = Operator(np.kron(np.kron(np.kron(Identity, Identity), Identity),
                          rotation_matrix(THETA[4])))
    R6 = Operator(np.kron(np.kron(np.kron(Identity, Identity), Identity),
                          rotation_matrix(THETA[5])))
    R7 = Operator(np.kron(np.kron(np.kron(Identity, Identity), Identity),
                          rotation_matrix(THETA[6])))
    R8 = Operator(np.kron(np.kron(np.kron(Identity, Identity), Identity),
                          rotation_matrix(THETA[7])))

    CN1 = C_NOT_001()
    CN2 = C_NOT_010()
    CN3 = C_NOT_100()

    R = CN3.compose(R8).compose(CN1).compose(R7).compose(CN2).compose(
        R6).compose(CN1).compose(R5).compose(CN3).compose(R4).compose(
        CN1).compose(R3).compose(CN2).compose(R2).compose(CN1).compose(R1)
